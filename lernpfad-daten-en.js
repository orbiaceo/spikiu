...
(function (raum) {
  ...
  var AUFGABEN = {
    ...
    'a1.bahnhof': [
      { de:'Kaufe eine Fahrkarte nach Boston', es:'Compra un billete para Boston', en:'Buy a ticket to Boston' },
      { de:'Sag: hin und zurück, und frag, wann der Zug fährt', es:'Di que ida y vuelta y pregunta a qué hora sale', en:'Say round trip, and ask what time it leaves' },
      { de:'Frag, von welchem Gleis er fährt', es:'Pregunta de qué andén sale', en:'Ask which track it leaves from' }
    ],
    'a1.cafe': [
      ...
      { de:'Verneine und frag, was es kostet', es:'Di que no y pregunta cuánto le debes', en:'Say no and ask what you owe' }
    ],
    'a1.einkaufen': [
      { de:'Bejahe und sag, dass du nur diese Äpfel nimmst', es:'Di que sí y que solo llevas estas manzanas', en:'Say yes, and that you just have these apples' },
      { de:'Bejahe und frag, was das kostet', es:'Di que sí y pregunta cuánto es', en:'Say yes and ask how much that is' },
      { de:'Sag, dass du mit Karte zahlst', es:'Di que pagas con tarjeta', en:'Say you will pay by card' }
    ],
    'a1.familie': [
      { de:'Bejahe und sag, dass du eine Schwester hast', es:'Di que sí, que tienes una hermana', en:'Say yes, you have a sister' },
      { de:'Sag, dass sie Clara heißt', es:'Di que se llama Clara', en:'Say her name is Clara' },
    ...
    'a1.hotel': [
      ...
      { de:'Bedanke dich und frag, ob das Frühstück dabei ist', es:'Da las gracias y pregunta si el desayuno está incluido', en:'Say thanks and ask whether breakfast is included' },
      { de:'Frag, in welchem Stock das Zimmer ist', es:'Pregunta en qué planta está la habitación', en:'Ask which floor the room is on' }
    ],
    'a1.restaurant': [
      { de:'Sag, dass ihr zu zweit seid', es:'Di que son dos', en:'Say there are two of you' },
      { de:'Frag, was er empfiehlt', es:'Pregunta qué recomienda', en:'Ask what he recommends' },
      { de:'Bestelle den Lachs', es:'Pide el salmón', en:'Order the salmon' }
    ],
    'a1.taxi': [
    ...
    'a1.wetter': [
      { de:'Stimme zu und sag, dass die Sonne scheint und es warm ist', es:'Dale la razón y di que hace sol y calor', en:'Agree and say it is sunny and warm' },
      { de:'Sag, dass es morgen regnen soll', es:'Di que mañana dicen que va a llover', en:'Say it is supposed to rain tomorrow' },
    ...
    'a2.arzt': [
      { de:'Erzähle, dass du letzte Woche gestürzt bist und die Schulter schlimmer geworden ist', es:'Cuenta que te caíste la semana pasada y que el hombro ha empeorado', en:'Say you fell last week and your shoulder has gotten worse' },
    ...
    'a2.bahnhof': [
      { de:'Sag, dass dein Zug zwanzig Minuten Verspätung hat', es:'Di que tu tren lleva veinte minutos de retraso', en:'Say your train is running twenty minutes late' },
      { de:'Sag: in Albany, um Viertel nach drei', es:'Di que en Albany, a las tres y cuarto', en:'Say in Albany, at quarter past three' },
    ...
    'a2.cafe': [
      ...
      { de:'Nimm den Zitronenkuchen und sag, dass du allergisch bist', es:'Pide el de limón y di que eres alérgico', en:'Take the lemon cake and say you are allergic' }
    ],
    'a2.einkaufen': [
      { de:'Sag, dass du das Hemd gestern gekauft hast und es dir zu groß ist', es:'Di que compraste esta camisa ayer y que te queda grande', en:'Say you bought this shirt yesterday and it is too big on you' },
      ...
      { de:'Sag: eine Nummer kleiner, und frag, ob du es anprobieren darfst', es:'Di que una talla menos y pregunta si te la puedes probar', en:'Say one size down and ask whether you can try it on' }
    ],
    'a2.familie': [
      { de:'Sag, dass ihr in einem kleinen Ort gewohnt habt', es:'Di que vivíais en un pueblo pequeño', en:'Say you lived in a small town' },
      { de:'Bejahe und erzähle, dass ihr euch sonntags bei der Tante getroffen habt', es:'Di que sí y cuenta que los domingos se reunían en casa de tu tía', en:'Say yes, and that on Sundays you all met at your aunt\'s' },
    ...
    'a2.hotel': [
      { de:'Sag, dass die Heizung nicht funktioniert', es:'Di que la calefacción no funciona', en:'Say the heat is not working' },
      ...
      { de:'Sag, dass du lieber das Zimmer wechseln möchtest', es:'Di que prefieres cambiar de habitación', en:'Say you would rather move rooms' }
    ],
    'a2.restaurant': [
      { de:'Frag nach der Spezialität des Hauses', es:'Pregunta cuál es la especialidad de la casa', en:'Ask what the house specialty is' },
      ...
      { de:'Nimm den Fisch und frag, ob ihr getrennt zahlen könnt', es:'Acepta el pescado y pregunta si pueden pagar por separado', en:'Take the fish and ask whether you can split the check' }
    ],
    'a2.taxi': [
      { de:'Sag, dass du zum Flughafen willst und es eilig hast', es:'Di que vas al aeropuerto y que tienes prisa', en:'Say you are going to the airport and you are in a bit of a rush' },
      { de:'Frag, ob der Weg durch die Stadt wirklich schneller ist', es:'Pregunta si por el centro es de verdad más rápido', en:'Ask whether that is actually faster' },
      { de:'Sag: dann diesen Weg, und frag nach einer Quittung', es:'Di que vaya por ahí y pregunta por un recibo', en:'Say let us do that, and ask for a receipt' }
    ],
    'a2.wegbeschreibung': [
    ...
    'a2.wetter': [
      ...
      { de:'Frag, wie es am Nachmittag wird', es:'Pregunta qué tiempo hará por la tarde', en:'Ask about the afternoon' },
  ...
  var STATIONEN = {
    ...
    'a1.bahnhof': {
      /* Deine Rolle: was in dieser Szene GILT. Steht auf der Bühne, bevor
         es losgeht. Ohne sie verlangten die Aufgaben Aussagen über das echte
         Leben des Lerners — wer keine Schwester hat, müsste lügen. */
      deineRolle: { de:'Du willst nach Boston und wieder zurück.', es:'Quieres ir a Boston y volver.', en:'You want to go to Boston and come back.' },
    ...
    'a1.einkaufen': {
      /* Deine Rolle: was in dieser Szene GILT. Steht auf der Bühne, bevor
         es losgeht. Ohne sie verlangten die Aufgaben Aussagen über das echte
         Leben des Lerners — wer keine Schwester hat, müsste lügen. */
      deineRolle: { de:'Im Supermarkt kaufst du Äpfel und Käse. Du zahlst mit Karte.', es:'En el supermercado compras manzanas y queso. Pagas con tarjeta.', en:'At the supermarket you buy apples and cheese. You\'re paying by card.' },
      /* Abrundung: Spikius Reaktion NACH der dritten Aufgabe (R6). */
    ...
    'a1.hotel': {
      /* Deine Rolle: was in dieser Szene GILT. Steht auf der Bühne, bevor
         es losgeht. Ohne sie verlangten die Aufgaben Aussagen über das echte
         Leben des Lerners — wer keine Schwester hat, müsste lügen. */
      deineRolle: { de:'Du heißt Weber, hast zwei Nächte gebucht und checkst gerade ein.', es:'Te apellidas Weber, has reservado dos noches y estás registrándote.', en:'Your name is Weber, you\'ve booked two nights and you\'re checking in.' },
      /* Abrundung: Spikius Reaktion NACH der dritten Aufgabe (R6). */
    ...
    'a2.bahnhof': {
      /* Deine Rolle: was in dieser Szene GILT. Steht auf der Bühne, bevor
         es losgeht. Ohne sie verlangten die Aufgaben Aussagen über das echte
         Leben des Lerners — wer keine Schwester hat, müsste lügen. */
      deineRolle: { de:'Dein Zug hat zwanzig Minuten Verspätung. In Albany musst du um Viertel nach drei umsteigen.', es:'Tu tren lleva veinte minutos de retraso. En Albany tienes el transbordo a las tres y cuarto.', en:'Your train is twenty minutes late. You change in Albany at quarter past three.' },
      /* Eröffnung: grüßt, ohne Aufgabe 1 vorwegzunehmen. */
