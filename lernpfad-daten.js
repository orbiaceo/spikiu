...
(function (raum) {
  ...
  var AUFGABEN = {
    ...
    'a1.bahnhof': [
      { de:'Kaufe eine Fahrkarte nach Madrid', es:'Compra un billete para Madrid', en:'Buy a ticket to Madrid' },
      { de:'Sag: hin und zurück, und frag, wann der Zug fährt', es:'Di que ida y vuelta y pregunta a qué hora sale', en:'Say return, and ask what time it leaves' },
      { de:'Frag, von welchem Gleis er fährt', es:'Pregunta de qué vía sale', en:'Ask which platform it leaves from' }
    ],
    'a1.cafe': [
      { de:'Bestelle einen Kaffee', es:'Pide un café', en:'Order a coffee' },
      { de:'Sag, dass du ihn mit Milch möchtest', es:'Di que lo quieres con leche', en:'Say you want it with milk' },
      { de:'Verneine und bitte um die Rechnung', es:'Di que no y pide la cuenta', en:'Say no and ask for the bill' }
    ],
    'a1.einkaufen': [
      { de:'Bestelle ein Kilo Äpfel', es:'Pide un kilo de manzanas', en:'Ask for a kilo of apples' },
      { de:'Bestelle ein halbes Kilo Käse und frag, was er kostet', es:'Pide medio kilo de queso y pregunta cuánto vale', en:'Ask for half a kilo of cheese and what it costs' },
      { de:'Gib ihr zehn Euro und bedanke dich', es:'Dale diez euros y da las gracias', en:'Hand over ten euros and say thanks' }
    ],
    'a1.familie': [
      { de:'Bejahe und sag, dass du eine Schwester hast', es:'Di que sí, que tienes una hermana', en:'Say yes, you have a sister' },
      { de:'Sag, dass sie Klara heißt', es:'Di que se llama Clara', en:'Say her name is Clara' },
    ...
    'a1.restaurant': [
      ...
      { de:'Bedanke dich und frag, was er empfiehlt', es:'Da las gracias y pregunta qué recomienda', en:'Say thanks and ask what he recommends' },
      { de:'Bestelle den Fisch und einen Salat', es:'Pide el pescado y una ensalada', en:'Order the fish and a salad' }
    ],
    'a1.taxi': [
    ...
    'a1.wegbeschreibung': [
      { de:'Frag, wo der Marktplatz ist', es:'Pregunta dónde está la plaza', en:'Ask where the market square is' },
    ...
    'a2.arzt': [
      ...
      { de:'Sag, dass du nur Schmerztabletten nimmst und gegen Penizillin allergisch bist', es:'Di que solo tomas pastillas para el dolor y que eres alérgico a la penicilina', en:'Say you only take painkillers and that you are allergic to penicillin' },
    ...
    'a2.bahnhof': [
      { de:'Sag, dass dein Zug Verspätung hat, und frag, ob du den Anschluss verpasst', es:'Di que tu tren lleva retraso y pregunta si pierdes el enlace', en:'Say your train is late and ask whether you will miss your connection' },
      { de:'Sag: um drei, in Zaragoza', es:'Di que a las tres, en Zaragoza', en:'Say at three, in Zaragoza' },
    ...
    'a2.cafe': [
      ...
      { de:'Bedanke dich und frag, ob die Torte Nüsse enthält', es:'Da las gracias y pregunta si la tarta lleva frutos secos', en:'Say thanks and ask whether the cake has nuts in it' },
      { de:'Sag, dass du allergisch bist, und nimm die Zitronentorte', es:'Di que eres alérgico y pide la de limón', en:'Say you are allergic and take the lemon cake' }
    ],
    'a2.einkaufen': [
      { de:'Sag, dass du das Hemd gestern gekauft hast und es dir zu groß ist', es:'Di que compraste la camisa ayer y que te queda grande', en:'Say you bought the shirt yesterday and it is too big for you' },
      { de:'Bejahe und frag, ob du sie umtauschen kannst', es:'Di que sí y pregunta si puedes cambiarla', en:'Say yes and ask whether you can exchange it' },
      { de:'Sag: eine Nummer kleiner, und frag, ob du sie anprobieren darfst', es:'Di que una talla menos y pregunta si te la puedes probar', en:'Say one size down and ask whether you may try it on' }
    ],
    'a2.familie': [
      ...
      { de:'Bejahe und erzähle, dass ihr euch sonntags bei der Tante getroffen habt', es:'Di que sí y cuenta que los domingos os reuníais en casa de tu tía', en:'Say yes, and that on Sundays you all met at your aunt\'s' },
    ...
    'a2.hotel': [
      { de:'Sag, dass die Heizung in deinem Zimmer nicht funktioniert', es:'Di que la calefacción de tu habitación no funciona', en:'Say the heating in your room is not working' },
    ...
    'a2.restaurant': [
      { de:'Frag nach der Spezialität des Hauses', es:'Pregunta cuál es la especialidad de la casa', en:'Ask what the house speciality is' },
      ...
      { de:'Nimm den Fisch und bitte um getrennte Rechnungen', es:'Acepta el pescado y pide cuentas separadas', en:'Take the fish and ask for separate bills' }
    ],
    'a2.taxi': [
      ...
      { de:'Sag: dann diesen Weg, und bitte um eine Quittung', es:'Di que vaya por ahí y pide un recibo', en:'Say take that route, and ask for a receipt' }
    ],
    'a2.wegbeschreibung': [
    ...
    'a2.wetter': [
      { de:'Sag, es hängt vom Wetter ab, und frag nach der Vorhersage', es:'Di que depende del tiempo y pregunta por la previsión', en:'Say it depends on the weather and ask about the forecast' },
