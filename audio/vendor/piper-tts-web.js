...
const HF_BASE = "https://huggingface.co/rhasspy/piper-voices/resolve/main"; // SPIKIU-PATCH: rhasspy-Repo (Auftrag-Tabelle), MIT; OPFS-Cache greift weiter (huggingface.co)
...
const _TtsSession = class _TtsSession {
  ...
  async init() {
    ...
    __privateSet(this, _ort, await import("/audio/vendor/ort/ort.min.js")); // SPIKIU-PATCH: self-gehosteter ESM-Pfad statt bare specifier (keine Import-Map noetig)
