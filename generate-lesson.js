...
Return ONLY the JSON object.`;
  ...
  try {
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        // Festes JSON-Schema, reine Datenverarbeitung → Haiku.
        // Kein Caching: der Systemprompt traegt Name, Datum und den ganzen
        // Gesprachsverlauf, ist also pro Aufruf verschieden.
