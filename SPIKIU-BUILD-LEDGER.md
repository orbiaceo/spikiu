...
- ✅ **Reader-Lesebegleiter** — live auf cap1-es-v2. api/lesebegleiter.js + lesebegleiter.js + vercel.json.
- ▶ **NÄCHSTES:** Lesebegleiter ausrollen auf cap2/3/4-es + cap1–4-de (nur `<script src="lesebegleiter.js" defer>` einbinden). Siehe AKTUELLER-AUFTRAG.md.
- ℹ️ Hinweis: Teile 15–17 wurden ausnahmsweise direkt in claude.ai gebaut (Leo am Terminal), nicht von Claude Code — Code dennoch nach den Stack-Regeln (export default, process.cwd(), includeFiles, Naming Spikiu).
