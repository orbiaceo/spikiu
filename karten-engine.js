...
(function () {
  ...
  var CSS = ''
    ...
    + 'background:var(--acc,#2d6a4f);color:#fff;box-shadow:3px 3px 0 var(--ink,#15163a);'
    ...
    + '.spk-audio:active{transform:translate(2px,2px);box-shadow:0 0 0 var(--ink,#15163a)}'
    ...
    + '.spk-opt.correct{background:#e8f5ee;border-color:var(--acc,#2d6a4f);color:var(--acc,#2d6a4f)}'
    ...
    + '.spk-feedback.ok{color:var(--acc,#2d6a4f)}'
    + '.spk-feedback.no{color:#c67a1e}'
    + '.spk-btn{width:100%;max-width:280px;background:var(--acc,#2d6a4f);color:#fff;'
    + 'border:var(--ow,2.5px) solid var(--ink,#15163a);box-shadow:3px 3px 0 var(--ink,#15163a);'
    + 'border-radius:100px;padding:.8rem 1.4rem;font:800 1rem "DM Sans",sans-serif;cursor:pointer}'
    + '.spk-btn:active{transform:translate(2px,2px);box-shadow:0 0 0 var(--ink,#15163a)}'
    ...
    + 'color:var(--acc,#2d6a4f);margin-bottom:.35rem}'
